...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      A.SupabaseFunctions$(new A.main_closure());
    },
  ...
  A.main_closure.prototype = {
    call$1(request) {
      var t3,
        t1 = A.convertBody("Hello from Supabase Edge Functions!"),
        t2 = self.undefined;
      if (t2 == null)
        t2 = window.undefined;
      t3 = type$.JavaScriptObject;
      t2 = t3._as({status: 200, statusText: "", headers: t2});
      if (t1 == null)
        t1 = window.undefined;
      return new A.Response(A.callConstructor(globalThis.self.Response, [t1, t2], t3));
    },
    $signature: 20
  };
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait($async$self.$this.fetch.call$1(new A.Request()), $async$call$0);
            case 3:
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.MappedIterator, A.FixedLengthListMixin, A.Symbol, A.MapView, A.ConstantMap, A.JSInvocationMirror, A.Closure, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A._Required, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A.ListBase, A._UnmodifiableMapMixin, A.DateTime, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.JsObject, A.Request, A.Response, A.SupabaseFunctions]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.NativeByteBuffer, A.NativeTypedData]);
    _inheritMany(J.LegacyJavaScriptObject, [J.PlainJavaScriptObject, J.UnknownJavaScriptObject, J.JavaScriptFunction, A.Promise, A.JavaScriptObject0, A.JSObject, A.Number, A.Reflect]);
